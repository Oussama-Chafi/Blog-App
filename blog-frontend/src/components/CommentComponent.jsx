...
import { useDeleteCommentMutation, useGetCommentsQuery } from "../redux-toolkit/features/commentApiSlice/commentsApiSlice";
...
const GetComment = () => {
    ...
    // check if we got the id from the state 
            ...
            {commentsSuccess && comments && (
              <div className=" flex flex-col gap-2 w-full   ">
                ...
                {comments.map((element) => {
                  ...
                  <div
                    className=" bg-gray-300/90 py-3 px-3 w-full md:w-[60%] "
                    key={element._id}
                  >
                    ...
                    <div className="flex justify-between my-3">
                      <p className="max-w-[60%] wrap-break-word">
                        {element.content}
                      </p>
